! function(e, t) {
    ...
    function o(t) {
        ...
        if (t.imageUrl) {
            ...
            f.setAttribute("style", f.getAttribute("style") + "width:" + y + "px; height:" + p + "px")
        }
    ...
    function c() {
        var e = m();
        B(y(), 10), w(e), g(e, "showSweetAlert"), v(e, "hideSweetAlert"), I = t.activeElement;
    ...
    function l() {
        var n = m();
        T(y(), 5), T(n, 5), v(n, "showSweetAlert"), g(n, "hideSweetAlert"), v(n, "visible");
        ...
        v(a, "pulseWarning"), v(a.querySelector(".body"), "pulseWarningIns"), v(a.querySelector(".dot"), "pulseWarningIns"), e.onkeydown = A, t.onclick = O, I && I.focus(), M = void 0
    }

    function s() {
        var e = m();
        e.style.marginTop = C(m())
    }
    var u = ".sweet-alert",
        f = ".sweet-overlay",
        ...
        for (var f = m(), d = function(e) {
                ...
                switch (e.type) {
                    ...
                    case "focus":
                        ...
                        break;
                    case "click":
                        n && a && o ? (u.doneFunction(), u.closeOnConfirm && l()) : l()
                }
            }, y = f.querySelectorAll("button"), g = 0; g < y.length; g++) y[g].onclick = d, y[g].onmouseover = d, y[g].onmouseout = d, y[g].onmousedown = d, y[g].onfocus = d;
        O = t.onclick, t.onclick = function(e) {
            var t = e.target || e.srcElement,
                n = f === t,
                o = k(f, e.target),
                r = p(f, "visible"),
