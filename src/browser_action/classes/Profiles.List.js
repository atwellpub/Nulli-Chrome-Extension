...
var Profiles_List = (function() {
    ...
    var App = {
        ...
        build_cols: function() {
            ...
            $('<th>', {
                class: 'heading',
                id: 'th-profile-actions'
            }).appendTo(tr);
            $('<th>', {
                class: 'heading',
                id: 'th-profile-status'
            }).appendTo(tr);
            $('<th>', {
                class: 'heading',
                id: 'th-profile-description'
            }).appendTo(tr);
        ...
        get_actions: function(id) {
            ...
            $('<a>', {
                class: 'quick-action edit-profile',
                rel: id
            }).appendTo(actions);
            $('<a>', {
                class: 'quick-action delete-profile',
                rel: id
            }).appendTo(actions);
