...
var Controls = (function() {
    ...
    var App = {
        ...
        getModalHtml: function() {
            var html = '<div class="nulli-control-container"  id="nulli-control-container"  >' + ' 	<div class="nulli-handle" id="nulli-handle" style=""><span id="nulli-close">X</span></div>' + '	<div class="nulli-rules-preview-container"  id="nulli-rules-preview-container" draggable="true" >'
            /* +' 		<div class="nulli-note" style="">CSS</div>' */
            + '			<textarea id="nulli-css-rules"warp="hard" style="">' + '			</textarea>' + '			<div class="nulli-actions">' + ' 				<button class="nulli-button" id="nulli-button-add-rule-to-existing-profile" >Add rule to existing profile</button>' + '				<button class="nulli-button" id="nulli-button-add-rule-to-new-profile">Add rule to new profile</button>' + '			</div>' + '	</div>' + '	<div class="nulli-add-to-profiles-container" id="nulli-add-to-profiles-container">' + ' 		<select id="nulli-selected-profile">';
            ...
            html += ' 		</select>' + ' 		<button class="nulli-button" id="nulli-button-confirm-rule-to-existing-profile" >Add!</button>' + '	</div>' + '	<div class="nulli-add-new-profile-container" id="nulli-add-new-profile-container">' + ' 		<input type="text" id="nulli-new-profile-name"  placeholder="Enter profile name here">' + ' 		<button class="nulli-button" id="nulli-button-confirm-rule-to-new-profile">Create!</button>' + '	</div>' + '</div>';
