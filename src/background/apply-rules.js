        ...
        var construct = {
            ...
            init: function() {
                ...
                for (var id in obj.nulli.profiles) {
                    ...
                    console.log('Nulli Profile loaded:');
                    console.log(obj.nulli.profiles[id]['profile-name']);

                    /* Evaluate Javascript */
                    if (typeof obj.nulli.profiles[id]['javascript'] != 'undefined' && obj.nulli.profiles[id]['javascript'] ) {
                        console.log('loaded js');
                        eval(obj.nulli.profiles[id]['javascript']);
                    }

                    /* Adds CSS */
                    if (typeof obj.nulli.profiles[id]['css'] != 'undefined' && obj.nulli.profiles[id]['css']) {
